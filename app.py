...
if uploaded_file is not None:
    ...
    with col2:
        ...
        try:
            with st.spinner("Analyzing media quality, metadata, and relevance concurrently..."):
                # Execute the async verifier flow!
                result = asyncio.run(verifier.verify_media(file_path))
            ...
            st.info(f"**Metadata Score:** {details.get('metadata_score', 0)}/10  \n"
